...
export interface SelectedSkillConfig {
    skillId: string;
    name: string;
    context: 'indagine' | 'sopravvivenza' | 'sociale' | 'atletica' | 'conoscenza_arcana';
}
...
export interface SelectedPreviousQuestLink {
    ...
    title: string;
    linkType: 'conseguenza_diretta' | 'gancio_irrisolto' | 'vendetta_o_debito' | 'ritorno_sul_luogo';
...
export interface GranularQuestConfig {
    ...
    narrativeTone: 'Epico ed Eroico' | 'Cupo & Horror' | 'Investigativo & Mistero' | 'Survival & Tattico' | 'Divertente & Leggero' | 'Politico & Intrigo';
    primaryEncounterType: 'Bilanciato (Combattimento + Sociale + Esplorazione)' | 'Prevalentemente Combattimento' | 'Investigativo & Sociale' | 'Dungeon Crawl & Enigmi' | 'Furtivo & Infiltrazione';
    ...
    plotTwistLikelihood: 'Nessun Colpo di Scena' | 'Colpo di Scena Moderato' | 'Rivelazione Sconvolgente';
