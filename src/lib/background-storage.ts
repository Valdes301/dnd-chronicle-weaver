...
export const PRESETS_MAIN: PresetBackground[] = [
  {
    ...
    imageUrl: '/api/assets/hero-dnd-bg.jpg',
    defaultOpacity: 0.35,
  ...
  },
  {
    ...
    imageUrl: '/api/assets/handout-background.jpg',
    defaultOpacity: 0.3,
  ...
  },
  {
    ...
    imageUrl: '/api/assets/ancient-grimoire-bg.jpg',
    defaultOpacity: 0.3,
    defaultOverlayDarkness: 0.65
  },
  {
    ...
    imageUrl: '/api/assets/tavern-board-bg.jpg',
    defaultOpacity: 0.35,
