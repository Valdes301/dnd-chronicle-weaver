...
export const baseSpells: Spell[] = (spellData.spells as any[]).map(s => ({ ...s, source: 'base' as const }));
...
export const baseMonsters: Monster[] = monsterData.monsters as unknown as Monster[];
