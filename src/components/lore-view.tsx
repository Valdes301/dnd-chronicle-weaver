                            ...
                            <form onSubmit={handleSaveManual} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[10px] text-muted-foreground">Formattato in Markdown per il DM</span>
                                    </div>
                                    <Textarea 
                    ...
                    {viewingEntry && (
                        <div className="space-y-5">
                            ...
                            <div className="bg-muted/10 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-border/50 shadow-inner overflow-hidden">
                                <div className="prose prose-invert max-w-none font-serif text-sm sm:text-base leading-relaxed space-y-4 whitespace-pre-wrap break-words">
