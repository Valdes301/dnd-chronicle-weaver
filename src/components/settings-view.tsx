...
import { CheckCircle2, XCircle, ShieldCheck, Key, RefreshCw, Loader2, AlertTriangle, ShieldAlert, Trash2, AlertCircle, BarChart3, Activity, Zap, History, FolderOpen, Image as ImageIcon, FileText, Link2, Sparkles, Wand2, BookOpen, Check, Upload, FileUp, Lock } from 'lucide-react';
