...
import { FileUp, Wand2, Check, X, Shield, Sparkles, Skull, Wand, BrainCircuit, Info, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
...
export function ContentImporter({ campaignId }: ContentImporterProps) {
  ...
  const handleAnalyze = async () => {
    ...
    setIsAnalyzing(true);
    try {
      const result = await actions.catalogHandbookAction(textContent);
