...
import { getIsLocked, touchActivity, checkAutoLockExpiry, isPlayerMode, getBlockedViews } from '@/lib/pin-storage';

const ToolLoadingFallback = () => (
  <div className="p-8 flex flex-col items-center justify-center min-h-[260px] gap-3 text-muted-foreground">
    <Loader2 className="h-7 w-7 animate-spin text-primary" />
    <span className="text-xs uppercase tracking-wider font-mono">Caricamento strumento...</span>
  </div>
);

const EquipmentDb = dynamic(() => import('./equipment-db').then(m => m.EquipmentDb), { ssr: false, loading: ToolLoadingFallback });
const ItemsDb = dynamic(() => import('./items-db').then(m => m.ItemsDb), { ssr: false, loading: ToolLoadingFallback });
const MonstersDb = dynamic(() => import('./monsters-db').then(m => m.MonstersDb), { ssr: false, loading: ToolLoadingFallback });
const SpellsDb = dynamic(() => import('./spells-db').then(m => m.SpellsDb), { ssr: false, loading: ToolLoadingFallback });
const SkillsDb = dynamic(() => import('./skills-db').then(m => m.SkillsDb), { ssr: false, loading: ToolLoadingFallback });
const MapGenerator = dynamic(() => import('./map-generator').then(m => m.MapGenerator), { ssr: false, loading: ToolLoadingFallback });
const CatalogHandbook = dynamic(() => import('./catalog-handbook').then(m => m.CatalogHandbook), { ssr: false, loading: ToolLoadingFallback });
const UnifiedCardGenerator = dynamic(() => import('./unified-card-generator').then(m => m.UnifiedCardGenerator), { ssr: false, loading: ToolLoadingFallback });
const ExperimentalCardGenerator = dynamic(() => import('./experimental-card-generator').then(m => m.ExperimentalCardGenerator), { ssr: false, loading: ToolLoadingFallback });
const CardBackgroundUploader = dynamic(() => import('./card-background-uploader').then(m => m.CardBackgroundUploader), { ssr: false, loading: ToolLoadingFallback });
const LetterGenerator = dynamic(() => import('./letter-generator').then(m => m.LetterGenerator), { ssr: false, loading: ToolLoadingFallback });
const ShopManager = dynamic(() => import('./shop-manager').then(m => m.ShopManager), { ssr: false, loading: ToolLoadingFallback });
const WorldArchitect = dynamic(() => import('./world-architect').then(m => m.WorldArchitect), { ssr: false, loading: ToolLoadingFallback });
const NpcGenerator = dynamic(() => import('./npc-generator').then(m => m.NpcGenerator), { ssr: false, loading: ToolLoadingFallback });
const CombatGenerator = dynamic(() => import('./combat-generator').then(m => m.CombatGenerator), { ssr: false, loading: ToolLoadingFallback });
const TreasureGenerator = dynamic(() => import('./treasure-generator').then(m => m.TreasureGenerator), { ssr: false, loading: ToolLoadingFallback });
const NpcSummary = dynamic(() => import('./npc-summary').then(m => m.NpcSummary), { ssr: false, loading: ToolLoadingFallback });
const PlayerCharactersDb = dynamic(() => import('./player-characters-db').then(m => m.PlayerCharactersDb), { ssr: false, loading: ToolLoadingFallback });
const ArchiveView = dynamic(() => import('./archive-view').then(m => m.ArchiveView), { ssr: false, loading: ToolLoadingFallback });
const SettingsView = dynamic(() => import('./settings-view').then(m => m.SettingsView), { ssr: false, loading: ToolLoadingFallback });
const HomebrewCompendium = dynamic(() => import('./homebrew-compendium').then(m => m.HomebrewCompendium), { ssr: false, loading: ToolLoadingFallback });
const QuickImprovWidget = dynamic(() => import('./quick-improv-widget').then(m => m.QuickImprovWidget), { ssr: false, loading: ToolLoadingFallback });
const LoreView = dynamic(() => import('./lore-view').then(m => m.LoreView), { ssr: false, loading: ToolLoadingFallback });
const SystemPanel = dynamic(() => import('./system-panel').then(m => m.SystemPanel), { ssr: false, loading: ToolLoadingFallback });
const GranularQuestCreator = dynamic(() => import('./dnd/granular-quest-creator').then(m => m.GranularQuestCreator), { ssr: false, loading: ToolLoadingFallback });
const PartyXpManager = dynamic(() => import('./dnd/party-xp-manager').then(m => m.PartyXpManager), { ssr: false, loading: ToolLoadingFallback });
const CampaignInitializer = dynamic(() => import('@/components/campaign-initializer').then(m => m.CampaignInitializer), { 
  ssr: false, 
...
const CampaignDashboard = dynamic(() => import('@/components/campaign-dashboard').then(m => m.CampaignDashboard), { 
  ssr: false, 
  loading: () => <div className="p-12 flex justify-center items-center min-h-[300px]"><Loader2 className="h-8 w-8 animate-spin text-amber-500" /></div> 
});
const LockOverlay = dynamic(() => import('./lock-overlay').then(m => m.LockOverlay), { ssr: false });
const PinConfigDialog = dynamic(() => import('./pin-config-dialog').then(m => m.PinConfigDialog), { ssr: false });
...
function ManagerContent(props: CampaignManagerProps & { initialView?: string; onOpenPinConfig?: () => void }) {
  ...
  return (
    <>
        ...
        <SidebarInset className="relative overflow-x-hidden min-h-screen">
            ...
            <main className="w-full p-0 relative z-0">
                    ...
                    <header className="flex flex-col items-center justify-center text-center gap-2 border-b pb-6 mb-8 relative group w-full px-4 sm:px-6 lg:px-8 pt-6">
                        ...
                        <div className="md:hidden absolute left-0 top-0 flex flex-col items-center gap-1 z-10">
                            <Button 
                                ...
                                className="h-10 w-10 text-primary hover:bg-amber-500/10"
                                aria-label="Menu"
                            >
                ...
                <Sheet open={Boolean(overlayView && overlayView !== 'storia' && overlayView !== 'bacheca')} onOpenChange={(o) => !o && setOverlayView(null)}>
                    <SheetContent side="right" className="w-full sm:max-w-4xl max-w-[100vw] overflow-y-auto p-3.5 sm:p-6 md:p-8">
                        <SheetHeader className="mb-4 sm:mb-6 flex flex-col items-center justify-center text-center">
                            <SheetTitle className="text-xl sm:text-2xl font-headline flex items-center justify-center gap-2 w-full text-center flex-wrap">
                                {overlayView && VIEW_METADATA[overlayView]?.icon && 
                                    (() => {
                                        const Icon = VIEW_METADATA[overlayView].icon;
                                        return <Icon className="h-5 w-5 sm:h-6 sm:w-6 text-primary shrink-0" />;
                                    })()
                                } 
                                <span>{overlayView ? VIEW_METADATA[overlayView]?.title : 'Strumento'}</span>
                            </SheetTitle>
                            <SheetDescription className="text-center italic text-xs sm:text-sm px-1 leading-relaxed">
                                {overlayView ? VIEW_METADATA[overlayView]?.desc : 'Consulta i dati della campagna.'}
                            </SheetDescription>
                        </SheetHeader>
                        <div className="space-y-6 sm:space-y-8">
                            {overlayView && (
                                (playerModeActive && blockedViewsList.includes(overlayView)) ? (
                                    <BlockedViewShield
                ...
                <div className="w-full pt-0 mt-0">
                    {activeCampaign && (
                        overlayView === 'storia' ? (
                            (playerModeActive && blockedViewsList.includes('storia')) ? (
                                <BlockedViewShield
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-center sm:justify-between border-b border-border/60 pb-3">
