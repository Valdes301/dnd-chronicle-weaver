  ...
  return (
    <div className="relative min-h-[100dvh] w-full flex flex-col justify-center items-center overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden transform-gpu will-change-transform">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-black/20 via-black/45 to-black/75" />
      </div>
      ...
      <div className="flex flex-col items-center justify-center p-4 sm:p-6 py-12 sm:py-16 md:py-20 text-center mx-auto w-full max-w-4xl my-auto">
        <div className="mb-6 animate-fade-in-up shrink-0">
          <div className="p-4 rounded-3xl bg-primary/10 border border-primary/20 backdrop-blur-md shadow-2xl shadow-primary/10 inline-block">
            <Icons.logo className="h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 mx-auto text-primary" />
          </div>
        </div>
