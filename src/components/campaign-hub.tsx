  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: bgStyle.backgroundImage || "url('/tavern-board-bg.jpg')",
        ...
        <div className="flex items-center gap-2">
          {onToggleSidebar && (
            <Button 
                ...
                className="h-10 w-10 text-amber-300 hover:bg-amber-950/50"
                aria-label="Menu"
            >
      ...
      <div className="relative z-10 text-center space-y-3 border-b border-amber-800/40 pb-6 pt-4">
        ...
        {/* Contenitore con centratura geometrica assoluta */}
        <div className="relative w-full flex items-center justify-center min-h-[48px] px-4">
          <div 
            ...
            className={`w-full max-w-3xl mx-auto text-center transition-opacity duration-200 ${
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight font-headline text-transparent bg-clip-text bg-gradient-to-r from-amber-100 via-amber-300 to-amber-100 drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)] text-center w-full">
              {campaign.name}
            </h2>
          </div>

          {/* Selettore cambio campagna posizionato a destra in modo assoluto e non invasivo */}
