...
export function LockOverlay({ onUnlock, onOpenPinSettings }: LockOverlayProps) {
  ...
  return (
    <div 
      ...
      } backdrop-blur-2xl bg-black/90 text-amber-100 overflow-y-auto overflow-x-hidden`}
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: bgStyle.backgroundImage || `radial-gradient(circle at center, rgba(30, 20, 10, 0.75) 0%, rgba(10, 7, 5, 0.95) 70%, rgba(0, 0, 0, 0.98) 100%)`,
        ...
        {viewState === 'seal' ? (
          ...
          >
            ...
            <div className="relative mb-4 flex items-center justify-center">
              ...
              <div 
                className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full border border-amber-500/30 border-dashed animate-spin ${
              ...
              <div 
                className={`absolute w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-amber-500/40 ${
                  isError 
              ...
              >
                {isSuccess ? (
                  <Unlock className="w-7 h-7 sm:w-8 sm:h-8 text-emerald-400 animate-bounce" />
                ) : isError ? (
                  <AlertCircle className="w-7 h-7 sm:w-8 sm:h-8 text-red-400 animate-pulse" />
                ) : (
            ...
            {/* Intestazione */}
            <h2 className="text-lg sm:text-xl font-headline font-bold text-amber-200 tracking-wide drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
              {usePasswordRecovery ? 'Recupero con Password' : 'Inserisci il Codice PIN'}
            </h2>
            <p className="text-[11px] sm:text-xs text-amber-400/80 font-serif italic mt-0.5 max-w-xs mb-4">
              {usePasswordRecovery 
            ...
            {!usePasswordRecovery ? (
              <>
                ...
                >
                  {[0, 1, 2, 3].map((index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className={`w-5 h-5 sm:w-6 sm:h-6 rounded-full border-2 transition-all duration-200 flex items-center justify-center ${
                          isError
                ...
                <div className="h-5 mb-2 flex items-center justify-center">
                  {isError && (
                    <span className="text-xs text-red-400 font-semibold tracking-wider animate-pulse">
                ...
                <div className="grid grid-cols-3 gap-2.5 sm:gap-3.5 w-full max-w-[270px] sm:max-w-[300px] mb-4">
                  ...
                  <button
                    ...
                    className="h-14 w-14 sm:h-16 sm:w-16 mx-auto rounded-full bg-stone-900/50 hover:bg-stone-800/80 active:scale-90 border border-stone-700/50 text-stone-400 hover:text-amber-200 transition-all duration-150 flex items-center justify-center focus:outline-none"
